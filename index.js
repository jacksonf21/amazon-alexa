...
const CancelAndStopIntentHandler = {
  canHandle(handlerInput) {
    return handlerInput.requestEnvelope.request.type === 'IntentRequest' && (handlerInput.requestEnvelope.intent.name === 'AMAZON.CancelIntent' || handlerInput.requestEnvelope.intent.name === 'AMAZON.StopIntent'); 
  },
  handle(handlerInput) {
